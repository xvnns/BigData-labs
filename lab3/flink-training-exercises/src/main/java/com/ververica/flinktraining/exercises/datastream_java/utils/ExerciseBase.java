...
public class ExerciseBase {
	...
	public final static String pathToRideData = "E:/Магистратура/1 семестр/Big Data/data/nycTaxiRides.gz";
	public final static String pathToFareData = "E:/Магистратура/1 семестр/Big Data/data/nycTaxiFares.gz";
